// Reduced from packages/durable/src/types.ts (362 lines).
// Dropped: DocumentRecord/DocumentCreate — a type-only future-runtime schema
// (no method in Storage touches documents) with session/conversation/task
// scopes and history/fork policy variants. Everything else is the real
// contract. Context/JsonValue/Message are defined locally so the copy is
// standalone.

// --- Local stand-ins for the chord/pi-ai shapes (opaque to durable) ---
