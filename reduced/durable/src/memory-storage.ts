// Verbatim port of packages/durable/src/memory-storage.ts. Imports resolve to
// local stand-ins; nothing else changed.
...
import type { Context, JsonValue } from "./types.ts";
