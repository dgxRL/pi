// Reduced from packages/coding-agent/src/core/tools/edit-diff.ts.
// Dropped: generateUnifiedPatch, computeEditsDiff/computeEditDiff preview wrappers, and the
// context-elision in generateDiffString (replaced by a plain +/- line dump).
...
/**
 * Generate a display-oriented diff string: plain +/-/space line dump with the
