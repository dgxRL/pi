// Reduced from packages/protocol/src/protocol.ts: the wire envelope schemas.
// Dropped: AttachmentEnvelope (out-of-band presentation routing — remote-client
// plumbing, not the RPC core). Everything else verbatim.
