// Reduced from packages/chord/src/api.ts. defineService drops the
// RemoteServiceContract conditional-type overloads; everything else verbatim.

import { FacetKernel, disposeLoadedFacets } from "./facets.ts";
...
export function defineService<T>(id: string, options?: { readonly local?: boolean }): Service<T> {
