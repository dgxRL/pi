// Ported from packages/chord/test/context.test.ts. The reduced context module is
// a verbatim port of the original, so this suite is unchanged apart from the
// import path.
